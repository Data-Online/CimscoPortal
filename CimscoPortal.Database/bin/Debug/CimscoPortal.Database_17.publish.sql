...
CREATE TABLE [dbo].[MessageFormats] (
    ...
    [ShortFormat]     NVARCHAR (50)  NULL,
    [Element1]        NVARCHAR (100) NULL,
    [Element2]        NVARCHAR (100) NULL,
    PRIMARY KEY CLUSTERED ([MessageFormatId] ASC)
);


GO
PRINT N'Creating [dbo].[FK_PortalMessages_MessageFormats]...';


GO
ALTER TABLE [dbo].[PortalMessages] WITH NOCHECK
    ADD CONSTRAINT [FK_PortalMessages_MessageFormats] FOREIGN KEY ([MessageFormatId]) REFERENCES [dbo].[MessageFormats] ([MessageFormatId]);
...
GO
ALTER TABLE [dbo].[PortalMessages] WITH CHECK CHECK CONSTRAINT [FK_PortalMessages_MessageFormats];
