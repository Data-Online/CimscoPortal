...
GO
PRINT N'The following operation was generated from a refactoring log file aa39e07b-e3d6-45b2-8983-0aee8e367ee0';

PRINT N'Rename [dbo].[MessageTypes].[MessageType] to Description';


GO
EXECUTE sp_rename @objname = N'[dbo].[MessageTypes].[MessageType]', @newname = N'Description', @objtype = N'COLUMN';


GO
PRINT N'The following operation was generated from a refactoring log file ff8e2d26-7248-4414-81b8-1cc6646208f3';

PRINT N'Rename [dbo].[MessageTypes].[MessageElement] to PageElement';


GO
EXECUTE sp_rename @objname = N'[dbo].[MessageTypes].[MessageElement]', @newname = N'PageElement', @objtype = N'COLUMN';
...
GO
INSERT [dbo].[MessageTypes] ([MessageTypeId], [MessageType], [MessageElement]) VALUES (1, N'Alert', N'pg-alert')
GO
INSERT [dbo].[MessageTypes] ([MessageTypeId], [MessageType], [MessageElement]) VALUES (2, N'Note', N'pg-note')
GO
INSERT [dbo].[MessageTypes] ([MessageTypeId], [MessageType], [MessageElement]) VALUES (3, N'ToDo', N'pg-todo')
GO
