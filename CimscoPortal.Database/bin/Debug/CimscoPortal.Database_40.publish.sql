...
ALTER TABLE [dbo].[InvoiceSummaries]
    ADD [InvoiceSummaryId] INT IDENTITY (1, 1) NOT NULL;


GO
PRINT N'Creating [dbo].[PK_InvoiceSummaries]...';


GO
ALTER TABLE [dbo].[InvoiceSummaries]
    ADD CONSTRAINT [PK_InvoiceSummaries] PRIMARY KEY CLUSTERED ([InvoiceSummaryId] ASC);
