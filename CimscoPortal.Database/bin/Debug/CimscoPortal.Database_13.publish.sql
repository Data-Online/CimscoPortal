...
GO
PRINT N'The following operation was generated from a refactoring log file 7e859cea-f22d-4e98-b839-2e9838aaa99f';

PRINT N'Rename [dbo].[PortalMessages].[MessageText] to Message';


GO
EXECUTE sp_rename @objname = N'[dbo].[PortalMessages].[MessageText]', @newname = N'Message', @objtype = N'COLUMN';
