...
GO
ALTER TABLE [dbo].[InvoiceSummaries]
    ADD [NetworkChargesTotal] DECIMAL (10, 2) NULL,
        [BalanceOutstanding]  DECIMAL (10, 2) NULL;
...
SELECT        Invoices.PreviousBalance, Invoices.PaymentsReceived, Invoices.PaymentReceivedDate, Invoices.PromptPaymentDiscountReceived, Invoices.PromptPaymentDiscountAvailable, 
                         Invoices.PromptPaymentDueDate, Invoices.TotalOwing, Invoices.GstTotal, Invoices.InvoiceTotal, Invoices.AccountNumber, Invoices.CustomerNumber, Invoices.AccountManager, Invoices.GSTCharges, 
                         EnergySuppliers.SupplierName, Invoices.InvoiceDate, Invoices.PeriodStart, Invoices.PeriodStop, Customers.CustomerName, EnergyPoints.ConnectionNumber, Invoices.SiteId, Invoices.TotalCharges, 
                         Invoices.MiscChargesTotal, Invoices.EnergyChargesTotal, Sites.SiteName, Invoices.NetworkChargesTotal, Invoices.BalanceOutstanding
