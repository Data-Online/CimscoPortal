...
GO
PRINT N'The following operation was generated from a refactoring log file 266a0ed9-6076-461c-9dd9-2f6d5c713b13';

PRINT N'Rename [dbo].[MessageTypes].[Type] to TypeName';


GO
EXECUTE sp_rename @objname = N'[dbo].[MessageTypes].[Type]', @newname = N'TypeName', @objtype = N'COLUMN';


GO
PRINT N'The following operation was generated from a refactoring log file 5487428a-f4f6-4024-83c9-6d9f92454f24';

PRINT N'Rename [dbo].[MessageCategories].[Category] to CategoryName';


GO
EXECUTE sp_rename @objname = N'[dbo].[MessageCategories].[Category]', @newname = N'CategoryName', @objtype = N'COLUMN';
...
INSERT INTO [dbo].[MessageCategories] ([MessageCategoryId], [CategoryName]) VALUES (2, N'alert_phone_blue')
INSERT INTO [dbo].[MessageCategories] ([MessageCategoryId], [CategoryName]) VALUES (4, N'alert_tick_red')
SET IDENTITY_INSERT [dbo].[MessageCategories] OFF

GO
SET IDENTITY_INSERT [dbo].[MessageTypes] ON
INSERT INTO [dbo].[MessageTypes] ([MessageTypeId], [TypeName]) VALUES (1, N'Alert')
INSERT INTO [dbo].[MessageTypes] ([MessageTypeId], [TypeName]) VALUES (2, N'Mail')
INSERT INTO [dbo].[MessageTypes] ([MessageTypeId], [TypeName]) VALUES (3, N'Task')
INSERT INTO [dbo].[MessageTypes] ([MessageTypeId], [TypeName]) VALUES (4, N'Chat')
...
INSERT INTO [dbo].[PortalMessages] ([PortalMessageId], [CustomerId], [MessageCategoryId], [Message], [MessageTypeId]) 
	VALUES (1, 
			...
			(select MessageCategoryId from dbo.MessageCategories where CategoryName = 'alert_phone_blue'), 
...
INSERT INTO [dbo].[PortalMessages] ([PortalMessageId], [CustomerId], [MessageCategoryId], [Message], [MessageTypeId]) 
	VALUES (2, 
			(select CustomerId from dbo.Customers where CustomerName = 'Customer1'), 
			(select MessageCategoryId from dbo.MessageCategories where CategoryName = 'alert_tick_red'), 
			N'Test tick message', 
			(select MessageTypeId from dbo.MessageTypes where [TypeName] = 'Alert')
			)
