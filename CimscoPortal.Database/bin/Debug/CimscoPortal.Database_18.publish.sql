...
GO
PRINT N'Dropping [dbo].[FK_PortalMessages_MessageFormats]...';


GO
ALTER TABLE [dbo].[PortalMessages] DROP CONSTRAINT [FK_PortalMessages_MessageFormats];


GO
PRINT N'Altering [dbo].[MessageCategories]...';


GO
ALTER TABLE [dbo].[MessageCategories]
    ADD [Element1] NVARCHAR (50) NULL,
